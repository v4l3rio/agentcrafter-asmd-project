 ...
 * 
 * Provides shared functionality for cleaning LLM decorations, extracting content
 * from various formats, and handling common parsing errors across different
 * LLM-generated content types.
 */
object LLMResponseParser:

  /**
   * Removes common LLM decorations from response strings.
   * Handles markdown code blocks, prefixes, and other common LLM formatting.
   */
   ...
   * @return Try containing cleaned JSON string
   */
   ...
   * 
   * @param response Raw LLM response
   * @return Try containing ASCII art string
   */
   ...
   * 
   * @param response Raw LLM response
   * @param patterns List of regex patterns to try in order
   * @return Try containing extracted content
   */
   ...
   * @param contentType Type description for error messages
   * @return Try containing validated content
   */
